...
public class SmsService {
	...
	public void sendTextMessage(ScheduledAppointmentDetail scheduleAppointmentDetail) {
		try {
			...
			Message.creator(new PhoneNumber(phone), new PhoneNumber(trialNumber),
					getMessageContent(scheduleAppointmentDetail)).create();
		} catch (Exception e) {
